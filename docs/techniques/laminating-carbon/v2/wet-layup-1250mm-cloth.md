...
bill_of_materials:
  - material: materials/carbon-fiber-fabric.md
    description: 1 linear metre of 200 g/m² 3K 2/2 twill cloth, 1250 mm width
    quantity:
      amount: 1
...
Baseline wet layup recipe using 1250 mm wide 0/90 twill carbon cloth for larger cutting plans.

## Goal
Produce a basic carbon blade using a manual wet layup.

## Specifications / Dimensions
- Uses 0/90 3K twill carbon cloth in the 1250 mm width
- Geometry and taper follow the chosen cutting template

## Reference Images

| ![Wet Carbon Laminate](../v1/sf_laminate_wet.jpeg) | ![Cured Carbon Laminate](../v1/sf_laminate_cured.jpeg) |
|-----------------------------------------------------|--------------------------------------------------------|
